...
@Component({selector:'app-reset-password',imports:[FormsModule,RouterLink,LanguageSwitcherComponent,TranslatePipe],templateUrl:'./reset-password.component.html',styleUrl:'./login.component.scss'})
