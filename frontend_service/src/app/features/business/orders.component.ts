...
export class OrdersComponent implements OnInit {
  ...
  allowedStatuses(order:OrderResponse):readonly OrderStatus[]{if(this.role==='ROLE_CSM'){return order.statutCommande==='EN_ATTENTE'?['CONFIRMEE','ANNULEE']:order.statutCommande==='CONFIRMEE'?['ANNULEE']:[]}if(this.role==='ROLE_LOGISTIC'){return order.statutCommande==='CONFIRMEE'?['PREPARATION','ANNULEE']:order.statutCommande==='PREPARATION'?['ANNULEE']:[]}return[]}
